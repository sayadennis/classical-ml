...
class ClassicalML():
    ...
    def lrm_cv(self, X_train, y_train, seed=0):
        ...
        gsLR = GridSearchCV(
            ...
            param_grid=self.lrm_params, n_jobs=8, scoring="balanced_accuracy", refit=True,
    ...
    def lasso_cv(self, X_train, y_train, seed=0):
        ...
        gsLS = GridSearchCV(
            ...
            param_grid=self.lasso_params, n_jobs=8, scoring="balanced_accuracy", refit=True,
            cv=StratifiedKFold(n_splits=5, random_state=seed, shuffle=True)
        )
    ...
    def elasticnet_cv(self, X_train, y_train, seed=0):
        ...
        gsEN = GridSearchCV(
            ...
            param_grid=self.elasticnet_params, n_jobs=8, scoring="balanced_accuracy", refit=True,
            cv=StratifiedKFold(n_splits=5, random_state=seed, shuffle=True)
        )
    ...
    def svm_cv(self, X_train, y_train, seed=0):
        ...
        gsCV = GridSearchCV(
            ...
            param_grid=self.svm_params, n_jobs=8, scoring="balanced_accuracy", refit=True,
            cv=StratifiedKFold(n_splits=5, random_state=seed, shuffle=True)
        )
    ...
    def rf_cv(self, X_train, y_train, seed=0):
        ...
        gsRF = GridSearchCV(
            ...
            param_grid=self.rf_params, n_jobs=8, scoring="balanced_accuracy", refit=True,
            cv=StratifiedKFold(n_splits=5, random_state=seed, shuffle=True)
        )
    ...
    def gb_cv(self, X_train, y_train, seed=0):
        ...
        gsGB = GridSearchCV(
            ...
            param_grid=self.gb_params, n_jobs=8, scoring="balanced_accuracy", refit=True,
            cv=StratifiedKFold(n_splits=5, random_state=seed, shuffle=True)
        )
    ...
    def xgb_cv(self, X_train, y_train, seed=0):
        ...
        gsXGB = GridSearchCV(
            ...
            param_grid=self.xgb_params, n_jobs=8, scoring="balanced_accuracy", refit=True,
            cv=StratifiedKFold(n_splits=5, random_state=seed, shuffle=True)
        )
    ...
    def record_tuning_NMF(self, X_train, y_train, X_test, y_test, outfn, k_list=None):
        if k_list is None:
